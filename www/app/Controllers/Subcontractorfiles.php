...
class Subcontractorfiles extends BaseController
{
	...
	public function getAll()
	{
		...
		$result = $this->subcontractorfilesModel->where('subcontractorid', $id)->findAll();
	...
	public function getOne()
	{
		...
		if ($this->validation->check($id, 'required|numeric')) {
			$data = $this->subcontractorfilesModel->where('subcontractorid', $id)->findAll();
			return $this->response->setJSON($data);
		} else {
	...
	public function remove()
	{
		$response = array();
		$id = $this->request->getPost('id');
		$data = $this->subcontractorfilesModel->find($id);
		$file = $data->filepath;
