                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="number" id="subcontractorid" name="subcontractorid" class="form-control"
                        placeholder="Subcontractorid" maxlength="11" number="true" required>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" id="filepath" name="filepath" class="form-control" placeholder="Filepath"
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" id="filetype" name="filetype" class="form-control" placeholder="Filetype"
                        maxlength="250" required>
                    </div>
                  </div>
                </div>
