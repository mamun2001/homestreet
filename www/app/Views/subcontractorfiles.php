...
<head>
  ...
  <title>Subcontractor Files</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Subcontractor Files</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Subcontractor Files</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									<label for="subcontractorid"> Subcontractorid: <span class="text-danger">*</span> </label>
									<input type="number" id="subcontractorid" name="subcontractorid" class="form-control" placeholder="Subcontractorid" maxlength="11" number="true" required>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
							...
							<div class="col-md-4">
								<div class="form-group">
									<label for="filepath"> Filepath: <span class="text-danger">*</span> </label>
									<input type="text" id="filepath" name="filepath" class="form-control" placeholder="Filepath" maxlength="500" required>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									<label for="filetype"> Filetype: <span class="text-danger">*</span> </label>
									<input type="text" id="filetype" name="filetype" class="form-control" placeholder="Filetype" maxlength="250" required>
								</div>
							</div>
						</div>
...
function edit(id) {
	$.ajax({
		...
		success: function(response) {
			...
			$("#edit-form #subcontractorid").val(response.subcontractorid);
			$("#edit-form #title").val(response.title);
			$("#edit-form #filepath").val(response.filepath);
			$("#edit-form #filetype").val(response.filetype);
