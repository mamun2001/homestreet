					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="text" id="companyPerson" name="companyPerson" class="form-control"
									placeholder="Company person" maxlength="250" required>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="text" id="address" name="address" class="form-control"
									placeholder="Address" maxlength="500" required>
							</div>
						</div>
					</div>
