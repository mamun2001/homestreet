...
use App\Models\TestSpecModel;

class TestSpec extends BaseController
{
	
    protected $testSpecModel;
    protected $validation;
	
	public function __construct()
	{
	    $this->testSpecModel = new TestSpecModel();
	...
	public function getAll()
	{
		...
		$result = $this->testSpecModel->select('id, Code_NutrSpec, NutrSpecification, Short_Name, Unit, Restriction_Type, Value')->findAll();
	...
	public function add()
	{
        ...
        if ($this->validation->run($fields) == FALSE) {
            ...
            if ($this->testSpecModel->insert($fields)) {
	...
	public function edit()
	{
        ...
        if ($this->validation->run($fields) == FALSE) {
            ...
            if ($this->testSpecModel->update($fields['id'], $fields)) {
	...
	public function remove()
	{
		...
		if (!$this->validation->check($id, 'required|numeric')) {
			...
			if ($this->testSpecModel->where('id', $id)->delete()) {
