...
class Composition extends BaseController
{
	...
	public function storePost()
    {
		...
		// $this->input->post('addmore');

        if(!empty($this->request->getPost('addmore'))){

            foreach ($this->request->getPost('addmore') as $key => $value) {
				$this->compositionModel->insert($value);
	...
	public function getAll()
	{
		...
		$result = $this->compositionModel->select('id, name')->findAll();
	...
	public function add()
	{
        ...
        if ($this->validation->run($fields) == FALSE) {
            ...
            if ($this->compositionModel->insert($fields)) {
	...
	public function edit()
	{
        ...
        if ($this->validation->run($fields) == FALSE) {
            ...
            if ($this->compositionModel->update($fields['id'], $fields)) {
	...
	public function remove()
	{
		...
		if (!$this->validation->check($id, 'required|numeric')) {
			...
			if ($this->compositionModel->where('id', $id)->delete()) {
