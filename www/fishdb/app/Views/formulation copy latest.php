			...
			<section class="content-header">
				...
				<div class="row">
					...
					<ul>
						...
						<li><a class='myTag' href="#" rel="three">Four</a></li>
						<li><a class='myTag' href="#" rel="three">Five</a></li>
						<li><a class='myTag' href="#" rel="three">Six</a></li>
						<li><a class='myTag' href="#" rel="three">Seven</a></li>
						<li><a class='myTag' href="#" rel="three">Eight</a></li>
						<li><a class='myTag' href="#" rel="three">Nine</a></li>
					</ul>
					</div>
					<div class="col-md-9">
