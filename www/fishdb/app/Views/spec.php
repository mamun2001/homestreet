...
<body class="hold-transition sidebar-mini">
						...
						<div class="card">
							<div class="card-header">
								...
								<div class="row">
									...
									<div class="form-group">
										<select name="target_moisture" id="target_moisture" class="form-control" style="width:200px">
											<!--<option value="0">-- Target Moisture --</option>-->
											<?php foreach ($target_moisture_level as $key => $value) {
												if ($value == '10') {
													echo "<option value='" . $key . "' selected>" . $value . "</option>";
												} else {
													echo "<option value='" . $key . "'>" . $value . "</option>";
						...
						<div class="modal-body">
							<form id="add-form" class="pl-3 pr-3">
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											...
											<!-- <input type="text" id="codeNutrSpec" name="codeNutrSpec" class="form-control" placeholder="Code NutrSpec" maxlength="7" > -->
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											...
											<!-- <input type="text" id="nutrSpecification" name="nutrSpecification" class="form-control" placeholder="NutrSpecification" maxlength="20" > -->
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											...
											<!-- <input type="text" id="shortName" name="shortName" class="form-control" placeholder="Short Name" maxlength="8"> -->
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											<label for="stage_weight"> Stage Weight: </label>
											<select name="stage_weight" id="stage_weight" class="form-control" style="width:200px">												
												<?php foreach ($stage_weight as $key => $value) {
													if ($key == '2') {
														echo "<option value='" . $key . "' selected>" . $value . "</option>";
									...
									<div class="col-md-4">
										<div class="form-group">
											<label for="target_moisture"> Target Moisture Level: </label>
											<select name="target_moisture" id="target_moisture" class="form-control" style="width:200px">												
												<?php foreach ($target_moisture_level as $key => $value) {
													if ($value == '10') {
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											<label for="codeNutrSpec"> Code NutrSpec: </label>
											<input type="text" id="codeNutrSpec" name="codeNutrSpec" class="form-control" placeholder="Code NutrSpec" maxlength="7">
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<label for="nutrSpecification"> NutrSpecification: </label>
											<input type="text" id="nutrSpecification" name="nutrSpecification" class="form-control" placeholder="NutrSpecification" maxlength="20">
										</div>
									</div>
									<div class="col-md-4">
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											...
											<input type="text" id="unit" name="unit" class="form-control" placeholder="Unit" maxlength="15">
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<label for="restrictionType"> Restriction Type: </label>
											<input type="text" id="restrictionType" name="restrictionType" class="form-control" placeholder="Restriction Type" maxlength="7">
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
	...
	<script>
		...
		$('#target_moisture').on('change', function() {
			filterData();
		});
		...
		function filterData() {
			...
			var a = $('#target_moisture').val();

			$.ajax({
				url: "<?php echo base_url($controller . '/getMatched') ?>",
				dataType: 'JSON',
				method: 'POST',
				data: {
		...
		function edit(id) {
			$.ajax({
				...
				success: function(response) {
					...
					$("#edit-form #codeNutrSpec").val(response.Code_NutrSpec);
					$("#edit-form #nutrSpecification").val(response.NutrSpecification);
					$("#edit-form #shortName").val(response.Short_Name);
					$("#edit-form #unit").val(response.Unit);
					$("#edit-form #restrictionType").val(response.Restriction_Type);
