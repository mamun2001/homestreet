        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Geeti</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
				...
				<div class="modal-body">
					<form id="add-form" class="pl-3 pr-3">								
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									<label for="raag"> Raag: </label>
									<input type="text" id="raag" name="raag" class="form-control" placeholder="Raag" maxlength="250" >
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<label for="taal"> Taal: </label>
									<input type="text" id="taal" name="taal" class="form-control" placeholder="Taal" maxlength="250" >
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<textarea cols="40" rows="5" id="body" name="body" class="form-control" placeholder="Body" required></textarea>
								</div>
							</div>
						</div>
					...
					<form id="edit-form" class="pl-3 pr-3">
						...
						<div class="row">
							<div class="col-md-8">
								<div class="form-group">
									<label for="body"> Body: <span class="text-danger">*</span> </label>
									<textarea cols="80" rows="15" id="body" name="body" class="form-control" placeholder="Body" required></textarea>
								</div>
							</div>
						</div>
...
function edit(id) {
	$.ajax({
		...
		success: function(response) {
			...
			$("#edit-form #raag").val(response.raag);
			$("#edit-form #taal").val(response.taal);
			$("#edit-form #body").val(response.body);
