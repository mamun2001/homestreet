  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Target Moisture</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Target Moisture</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="card">
            <div class="card-header">
              <div class="row">
				  ...
				  <h3 class="card-title">Target Moisture</h3>
			  	</div>
				<div class="col-md-4">
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									<label for="targetMoistureLevel"> Target moisture level: </label>
									<input type="text" id="targetMoistureLevel" name="targetMoistureLevel" class="form-control" placeholder="Target moisture level" maxlength="50" >
								</div>
							</div>
						</div>
...
function edit(id) {
	$.ajax({
		...
		success: function(response) {
			...
			$("#edit-form #targetMoistureLevel").val(response.target_moisture_level);
