	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="">
				<div class="row">
					<div class="card-body col-12">
						<div class="form-inline">
							...
							<input type="button" class="btn btn-primary col-1 ml-2" value="Add" id="add" />
						</div>
					</div>
				</div>

				<div class="row">
					<div class="card col-3 ml-2" style="background-color: darkorange;">
					...
					<div class="card ml-2 col-3" style="background-color: chocolate;">
						<header class="card-header bg-primary">
							<a href="#" data-toggle="collapse" data-target="#collapse14" aria-expanded="true" class="">
								<i class="icon-action fa fa-chevron-down"></i>
								<span class="title">Feed Efficiency</span>
							</a>
						</header>
				...
				<div class="row">
					<div class="card col-3 ml-2" style="background-color: red;">
						<header class="card-header bg-primary">
					...
					<div class="card ml-2 col-3" style="background-color: steelblue;">
						<header class="card-header bg-primary">
							...
							<div class="card">
								...
								<div class="row">
									<div class="col-md-8 mt-2">
										<h3 class="card-title">Formulation</h3>
									</div>
									<div class="col-md-4">
