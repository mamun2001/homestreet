	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<div class="row">
					<div class="card col-4 ml-2" style="background-color: darkorange;">
					...
					<div class="card ml-2 col-3" style="background-color: gold;">
						<header class="card-header bg-primary">
						...
						<div class="collapse show" id="collapse12">
							<article class="card-body">
								...
								<!-- Recovery <span class="badge badge-light" id="recovery">0</span> &#37;<br>
								Feces Produced <span class="badge badge-light" id="fecesproduced">0</span> g/kg feed fed<br>
								Unrecovered-Feces <span class="badge badge-light" id="unrecoveredfeces">0</span> g/kg feed fed<br>
								Nitrogen Produced <span class="badge badge-light" id="nitrogenproduced">0</span> g/kg feed fed<br>
								Phophorus Produced <span class="badge badge-light" id="phophorusproduced">0</span> g/kg feed fed -->
							</article> <!-- card-body.// -->
						</div> <!-- collapse .// -->
					</div>
					<div class="card col-3 ml-2" style="background-color: olivedrab;">
						<header class="card-header bg-primary">
				...
				<div class="row">
					<div class="card ml-2 col-3" style="background-color: chocolate;">
						<header class="card-header bg-primary">
					...
					<div class="card col-3 ml-2" style="background-color: pink;">
						<header class="card-header bg-primary">
					...
					<div class="card ml-2 col-3" style="background-color: lightblue;">
						<header class="card-header bg-primary">
				...
				<div class="row">
					<div class="card ml-2 col-3" style="background-color: olive;">
						<header class="card-header bg-primary">
					...
					<div class="card col-3 ml-2" style="background-color: lightgreen;">
						<header class="card-header bg-primary">
							...
							<article class="card-body">
								<table class="table-bordered">
									<tr>
										...
										<td><span class="badge badge-light" id="NDF">0</span> gg/KJ</td>
										<td><span class="badge badge-light" id="NDF_std">0</span></td>
										<td>Min</td>
									</tr>
									<tr>
					...
					<div class="card ml-2 col-3" style="background-color: yellow;">
						<header class="card-header bg-primary">
