        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">UserProjects</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="card">
            <div class="card-header">
              <div class="row">
				  ...
				  <h3 class="card-title">UserProjects</h3>
			  	</div>
				<div class="col-md-4">
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="number" id="userid" name="userid" class="form-control" placeholder="Userid" maxlength="11" number="true" required>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<label for="projectid"> Projectid: <span class="text-danger">*</span> </label>
									<input type="number" id="projectid" name="projectid" class="form-control" placeholder="Projectid" maxlength="11" number="true" required>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
...
function edit(id) {
	$.ajax({
		...
		success: function(response) {
			...
			$("#edit-form #userid").val(response.userid);
			$("#edit-form #projectid").val(response.projectid);
