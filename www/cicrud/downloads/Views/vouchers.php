						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									<label for="summeryId"> Summery id: <span class="text-danger">*</span> </label>
									<input type="number" id="summeryId" name="summeryId" class="form-control" placeholder="Summery id" maxlength="11" number="true" required>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<label for="filePath"> File path: <span class="text-danger">*</span> </label>
									<input type="text" id="filePath" name="filePath" class="form-control" placeholder="File path" maxlength="500" required>
								</div>
							</div>
						</div>
...
function edit(id) {
	$.ajax({
		...
		success: function(response) {
			...
			$("#edit-form #summeryId").val(response.summery_id);
