						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									<label for="speciesTypeId"> Species type id: <span class="text-danger">*</span> </label>
									<input type="number" id="speciesTypeId" name="speciesTypeId" class="form-control" placeholder="Species type id" maxlength="11" number="true" required>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<label for="species"> Species: </label>
									<input type="text" id="species" name="species" class="form-control" placeholder="Species" maxlength="500" >
								</div>
							</div>
						</div>
...
function edit(id) {
	$.ajax({
		...
		success: function(response) {
			...
			$("#edit-form #speciesTypeId").val(response.species_type_id);
			$("#edit-form #species").val(response.species);
