        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Stage Weight</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="card">
            <div class="card-header">
              <div class="row">
				  ...
				  <h3 class="card-title">Stage Weight</h3>
			  	</div>
				<div class="col-md-4">
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									<label for="stageWeight"> Stage weight: </label>
									<input type="text" id="stageWeight" name="stageWeight" class="form-control" placeholder="Stage weight" maxlength="250" >
								</div>
							</div>
						</div>
...
function edit(id) {
	$.ajax({
		...
		success: function(response) {
			...
			$("#edit-form #stageWeight").val(response.stage_weight);
