...
<head>
  ...
  <title>Daily Expense Detail</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Daily Expense Detail</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Daily Expense Detail</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="card">
            <div class="card-header">
              <div class="row">
				  ...
				  <h3 class="card-title">Daily Expense Detail</h3>
			  	</div>
				<div class="col-md-4">
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									<label for="summaryId"> Summary id: <span class="text-danger">*</span> </label>
									<input type="number" id="summaryId" name="summaryId" class="form-control" placeholder="Summary id" maxlength="11" number="true" required>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<label for="headId"> Head id: <span class="text-danger">*</span> </label>
									<input type="number" id="headId" name="headId" class="form-control" placeholder="Head id" maxlength="11" number="true" required>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<label for="itemId"> Item id: <span class="text-danger">*</span> </label>
									<input type="number" id="itemId" name="itemId" class="form-control" placeholder="Item id" maxlength="11" number="true" required>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="number" id="categoryId" name="categoryId" class="form-control" placeholder="Category id" maxlength="11" number="true" >
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="number" id="modelId" name="modelId" class="form-control" placeholder="Model id" maxlength="11" number="true" >
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="number" id="sizeId" name="sizeId" class="form-control" placeholder="Size id" maxlength="11" number="true" >
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<label for="unitId"> Unit id: </label>
									<input type="number" id="unitId" name="unitId" class="form-control" placeholder="Unit id" maxlength="11" number="true" >
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<label for="rate"> Rate: <span class="text-danger">*</span> </label>
									<input type="number" id="rate" name="rate" class="form-control" placeholder="Rate" maxlength="11" number="true" required>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="number" id="qty" name="qty" class="form-control" placeholder="Qty" maxlength="11" number="true" required>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<label for="amount"> Amount: <span class="text-danger">*</span> </label>
									<input type="number" id="amount" name="amount" class="form-control" placeholder="Amount" maxlength="11" number="true" required>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" id="comment" name="comment" class="form-control" placeholder="Comment" maxlength="250" required>
								</div>
							</div>
						</div>
...
function edit(id) {
	$.ajax({
		...
		success: function(response) {
			...
			$("#edit-form #summaryId").val(response.summary_id);
