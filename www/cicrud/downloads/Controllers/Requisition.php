...
class Requisition extends BaseController
{
	...
	public function getAll()
	{
		...
		$result = $this->requisitionModel->select('id, project_id, user_id, requested_amount, submit_date_time, recieved_amount, recieve_date_time, recieved_by, status, comment')->findAll();
