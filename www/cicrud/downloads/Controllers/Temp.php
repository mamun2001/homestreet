...
class Temp extends BaseController
{
	...
	public function add()
	{
        ...
        $fields['percent'] = $this->request->getPost('percent');
        ...
        if ($this->validation->run($fields) == FALSE) {
            ...
            if ($this->tempModel->insert($fields)) {
	...
	public function edit()
	{
        ...
        if ($this->validation->run($fields) == FALSE) {
            ...
            if ($this->tempModel->update($fields['id'], $fields)) {
	...
	public function remove()
	{
		...
		if (!$this->validation->check($id, 'required|numeric')) {
			...
			if ($this->tempModel->where('id', $id)->delete()) {
